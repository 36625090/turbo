...
func NewFromString(value string) (Decimal, error) {
	...
	// OnTicker if number is using scientific notation
...
// AbsExponent returns the  abs exponent, or scale component of the decimal.
func (d Decimal) AbsExponent() int32 {
	return int32(math.Abs(float64(d.exp)))
}
